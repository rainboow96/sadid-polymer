            ...
            <div className="w-full max-w-[570px]">
              ...
              <FadeIn delay={0.3}>
                <p className="mt-5 max-w-[500px] text-[14px] leading-7 text-slate-300/90 sm:text-[15px]">
                  سدید پلیمر تولیدکننده تخصصی لوله‌های لی‌فلت آبیاری قطره‌ای و کیسه‌های کاشت نهال با مقاومت صنعتی، انعطاف‌پذیری بی‌نظیر و دوامی که برای شرایط سخت کشاورزی ایران طراحی شده است.
                </p>
              </FadeIn>
            </div>
