    ...
    return (
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent
                ...
                className="h-full w-full border-none bg-[#0a1220]/95 backdrop-blur-xl p-0 flex flex-col"
            >

                <div className="flex w-full items-center justify-end p-6">
                    <SheetClose
                        render={
                            <Button variant="ghost" size="icon-sm" aria-label="بستن منو" />
                        }
                    >
                                    ...
                                    >
                                        ...
                                        <ChevronDown
                                            ...
                                            className={`transition-transform duration-200 ${
                                                openSubmenu === link.title ? "rotate-180 text-cyan-400" : "text-slate-400"
                                            }`}
                                        />
                                    </button>
                    ...
                    <SheetClose
                        render={
                            <Button
                                variant="default"
                                size="lg"
                                className="w-full h-12 text-base font-semibold shadow-lg shadow-cyan-500/20 bg-gradient-to-r from-cyan-500 to-blue-600 hover:opacity-95"
